...
declare -A scripts=(
  ...
  ["8"]="docker.sh"
  ["9"]="https://raw.githubusercontent.com/akile-network/aktools/refs/heads/main/akdns.sh"
  ["10"]="unlock.sh"
  ["11"]="frp.sh"
  ["12"]="https://raw.githubusercontent.com/bin456789/reinstall/main/reinstall.sh || wget -O ${_##*/} $_"
  ["13"]="acme.sh"
  ["14"]="Alpine-vmess.sh"
  ["15"]="Alpine-hy2.sh"
  ["17"]="easytier.sh"
